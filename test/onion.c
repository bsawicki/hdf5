...
test_revision_index(void)
{
    ...
    /* TODO: more thorough insert/lookup testing
     * with known collisions and repeats
     */

    /* TODO: known resizing
     */

    /* test destroy (TODO: can it actually be tested?)
     */
...
#if 0
    nerrors -= test_onionize_existing_canonical(FALSE); /* w/immediate writes*/
    nerrors -= test_onionize_existing_canonical(TRUE);
#endif
    nerrors -= test_several_revisions_with_logical_gaps();
    nerrors -= test_page_aligned_history_create();
#if 0
    nerrors -= test_page_aligned_history_onionize();
#endif
    nerrors -= test_integration_create();

/* TODO: verify endianness out of files */
/* TODO: read spanning multiple pages/revisions */
/* TODO: page-alignment (reads/writes) */

/* TODO: instantiate onion from existing */
/* TODO: instantiate onion from nothing (failure) */
/* TODO: write revised data to onion */
/* TODO: instantiate and write revision to existing at once */
/* TODO: read data from onionizied file/revisions */
/* TODO: open nonexistent revisions R/O and R/W (failure) */
